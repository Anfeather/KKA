...
def create_semisupervised_setting(labels, normal_classes, outlier_classes, known_outlier_classes,
    ...
    # Locate indexes of normal and abnormal classes
    ...
    # Sample indices reorder the data
    ...
    print(f"idx_known_normal: {len(idx_known_normal)}")
    print(f"idx_unlabeled_normal: {len(idx_unlabeled_normal)}")
    print(f"idx_unlabeled_outlier: {len(idx_unlabeled_outlier)}")
    print(f"idx_known_outlier: {len(idx_known_outlier)}")


    print(f"list_idx length: {len(list_idx)}")
    print(f"list_semi_labels length: {len(list_semi_labels)}")
